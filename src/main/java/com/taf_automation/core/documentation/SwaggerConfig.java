package com.taf_automation.core.documentation;
...
public class SwaggerConfig {
    public static final List<String> DEFAULT_INCLUDE_PATTERNS = Arrays.asList("/rest/api/.*");
    public static final String SWAGGER_GROUP = "test-automation-framework";
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo(
                ...
                "The Test Automation Framework Backend APIs",
                "https://www.automationhq.com/rest/api/",
                "rajesh23427@gmail.com",
                "Apache 2.0",
